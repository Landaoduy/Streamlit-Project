...
MODEL = 'AIO-Project-Module1/MobileNetSSD_deploy.caffemodel'

PROTOTXT = 'AIO-Project-Module1/MobileNetSSD_deploy.prototxt.txt'


def process_image(image):
    blob = cv2.dnn.blobFromImage(cv2.resize(
        image, (300, 300)), 0.007843, (300, 300), (127.5, 127.5, 127.5))
...
def annotate_image(image, detections, confidence_threshold=0.5):
    ...
    for i in np.arange(0, detections.shape[2]):
        ...
        if confidence > confidence_threshold:
            ...
            # then compute the (x, y) - coordinate of the bounding box for the object
